...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Jean Lucas Eletricista | Eletricista Residencial em São José dos Campos',
    template: '%s | Jean Lucas Eletricista',
  },

  description:
    'Eletricista residencial em São José dos Campos. Instalação e manutenção de tomadas, chuveiros, luminárias, ventiladores, disjuntores, quadros elétricos e fiação.',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Quais serviços de elétrica residencial você realiza?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Você atende como eletricista em São José dos Campos?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
          'Sim. A Jean Lucas Eletricista realiza atendimento de elétrica residencial em São José dos Campos, com atendimento principalmente nas regiões informadas no site.',
      },
    },
    {
      '@type': 'Question',
      name: 'Quais regiões de São José dos Campos você atende?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Como solicitar um orçamento de eletricista?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'É possível enviar fotos do problema elétrico pelo WhatsApp?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Vocês fazem instalação de tomadas e interruptores?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Vocês fazem instalação de chuveiro elétrico?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Por que o disjuntor fica desarmando?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Vocês fazem troca e instalação de disjuntores?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Vocês fazem manutenção em quadro elétrico?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Por que uma tomada pode esquentar?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'O que fazer quando uma tomada está dando choque?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Vocês fazem instalação de luminárias e iluminação?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Vocês instalam ventilador de teto?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Vocês fazem reparos em fiação elétrica?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Quando devo chamar um eletricista residencial?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Vocês fazem manutenção elétrica residencial?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'O serviço de elétrica residencial possui garantia?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Quanto custa um serviço de eletricista em São José dos Campos?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
    ...
    {
      '@type': 'Question',
      name: 'Como contratar a Jean Lucas Eletricista?',
      acceptedAnswer: {
        '@type': 'Answer',
        text:
